...
const TicketBookingPage = () => {
    ...
    const handleSeatBooking = useCallback((seat) => {
        const newSeat = [seat, ...selectedSeat]
        const data = { date: selectedDate, time: selectedScheduleTime, seatType: selectedSeatType.seatType, seat: newSeat, totalAmount: totalAmount, movie: selectedMovie?._id, email: user.email }
        ...
        <div className="my-container py-24">
            <div className="flex flex-col md:flex-row gap-7  ">
                ...
                <div className="flex-1 ">
                    ...
                    {
                        seatTypesPrice && <div className="mb-9 flex flex-col md:flex-row gap-7">
                            <div className="basis-3/5 ">
                    ...
                    {
                        ticketQuantity > 0 && <div className="bg-white outline-dashed outline-1 outline-violet-900 p-4 md:p-6 rounded-md ">
                            <div className=" overflow-x-auto">
                                <div className="text-xs border-b-2 pb-4 mb-6">
                                    <div className="flex justify-between ">
                                        ...
                                        <div className="flex gap-4 text-sm font-semibold">
                                            <div className="flex items-center gap-1"><span className="w-6 h-5 md:w-9 md:h-6 rounded border border-green-500"></span>Available
                                            </div>
                                            <div className="flex items-center gap-1"><span className="w-6 h-5 md:w-9 md:h-6 rounded bg-yellow-500"></span>Selected
                                            </div>
                                            <div className="flex  items-center gap-1"><span className="w-6 h-5 md:w-9 md:h-6 rounded bg-slate-100"></span>Not Available
                                            </div>
                                        </div>
                                    </div>

                ...
                <div className="navbar min-h-[40px]  md:bg-gray-100 md:rounded-md md:mt-5 md:py-0  border-b md:border-none border-violet-700">
                    ...
                    <div className="flex-none">
                        <div className="flex items-center gap-2 md:hidden">
                            ...
                            <p className="text-xl font-bold  text-violet-800">BD Cinema House</p>
                ...
                <div className="min-h-full  w-80  bg-gray-100  ">
                    <div className="flex flex-col items-center gap-2 border-b p-4 mb-4">
                        ...
                        <div className="text-center pb-3 font-bold ">
                            <p className="text-xl md:text-2xl text-violet-800">BD Cinema House</p>

                        </div>
                        <div>
                            <Link className="flex md:hidden btn btn-sm btn-primary" onClick={() => handleLogout()}><FaRightToBracket /> Logout</Link>
                        </div>
                    </div>
                    <ul className="menu-item gap-1 p-4 w-80 min-h-full bg-base-200 text-base-content">
                        ...
                        <li><NavLink to={'/dashboard/all-user'} className={({ isActive }) => isActive ? "menu-item-active" : ""}><FaUsers /> Users</NavLink></li>
                        <li><NavLink to={'/dashboard/movies'} className={({ isActive }) => isActive ? "menu-item-active" : ""}><RiMovie2Fill /> Movies</NavLink></li>
                        <li><NavLink to={'/dashboard/shows'} className={({ isActive }) => isActive ? "menu-item-active" : ""}><FaGrip /> Movie Shows</NavLink></li>
                        <li><NavLink to={'/dashboard/all-booking'} className={({ isActive }) => isActive ? "menu-item-active" : ""}><FaTicket /> Booking</NavLink></li>
                    </ul>
                </div>
            </div>
        </div>
